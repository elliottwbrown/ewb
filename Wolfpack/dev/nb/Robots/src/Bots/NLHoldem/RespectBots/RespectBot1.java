...
public class RespectBot1 extends GenericBot  {
    
    public static final boolean checkRaiseOn=true;
    public static final String gameLogFile="c:\\temp\\RespectBot1.log";
    ...
    public RespectBot1() {
        System.out.println("instantiating RespectBot1");
        try {
            ...
            RiverAnalyzer.init();
            if (debugLevel>0) {
                gameLog.log("instantiating RespectBot1"+"\n");
    ...
    private void adjustWinProbForRespect() {
        adjWinProb=winProb;
